...
export default class SheetJSApp extends React.Component {
  ...
  submitHandler(){
    ...
    window.location.href="https://amiteshstockexchangefrontend.herokuapp.com/UploadFile";
}

  render() {
    return (
      <DragDropFile handleFile={this.handleFile}>
        <div><button className="submitBtn" onClick={this.submitHandler}>Upload</button></div>
        <div className="row">
  ...
  render() {
    return (
      <form className="form-inline">
        ...
        <h1 style ={{"color":"#e33371","font-family":"Brush Script MT","textAlign":"center","marginTop":"5%"}}>SpreadSheet</h1>
          <br></br>
          <input
            style = {{"color":"red","textAlign":"center","marginLeft":"45%"}}
            size = "30"
            type="file"
...
const sendData = async (jsonData) => {
  ...
  const response = await fetch('https://amiteshstockexchangebackend.herokuapp.com/addstockprices',
   {
    method: 'POST',
    body:jsonData, 
    headers: {
